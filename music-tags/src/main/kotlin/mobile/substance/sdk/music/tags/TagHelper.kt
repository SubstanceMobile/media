...
class TagHelper {
    ...
    internal class AsyncRead<T : MediaObject, R : TagObject>(private val context: Context, private val callback: ReadCallback<R?>) : AsyncTask<T?, Void, R?>() {
    ...
    companion object {
        ...
        fun read(context: Context, album: Album): TagAlbum? {
            ...
            MusicData.findSongsForAlbum(album).forEach {
