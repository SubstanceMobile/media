    ...
    private static List<Song> buildSongs(Context context) {
        ...
        try {
            ...
            do {
                ...
                s.setSongAlbumName(songsCursor.getString(artistColumn));
                s.setID(songsCursor.getLong(idColumn));
                s.setSongAlbumID(songsCursor.getLong(albumIdColumn));
                s.setSongDuration(songsCursor.getLong(durColumn));
                s.setSongTrackNumber(songsCursor.getInt(trackNumber));
                s.lock();
                mSongs.add(s);
    ...
    private static List<Album> buildAlbums(Context context) {
        ...
        try {
            ...
            do {
                ...
                album.setAlbumName(albumsCursor.getString(titleColumn));
                album.setAlbumArtistName(albumsCursor.getString(artistColumn));

                album.setAlbumArtworkPath(albumsCursor.getString(albumArtColumn));
    ...
    private static List<Playlist> buildPlaylists(Context context) {
        ...
        try {
            ...
            do {
                ...
                playlist.setPlaylistType(TextUtils.equals(name.toLowerCase(), "favorites") ? 0 : 1);
            ...
            Collections.sort(mPlaylists, new Comparator<Playlist>() {
                ...
                public int compare(Playlist lhs, Playlist rhs) {
                    return ((Integer) lhs.getPlaylistType()).compareTo(rhs.getPlaylistType());
                }
            });
