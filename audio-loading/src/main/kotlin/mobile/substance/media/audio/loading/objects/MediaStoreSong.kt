...
package mobile.substance.media.audio.loading.objects

import android.net.Uri
import android.provider.MediaStore
import mobile.substance.media.audio.loading.DateAdded
...
import mobile.substance.media.loading.core.MediaStoreAttributes

class MediaStoreSong : Song(), MediaStoreAttributes, DateAdded {
    var albumId: Long = -1
    var artistId: Long = -1

    override var artworkUri: String? = null
