...
import mobile.substance.media.audio.playback.R
...
interface MediaNotification {
     ...
     * @param playIntent The intent you should pass to your created notification in order to resume audio.
     * @param pauseIntent The intent you should pass to your created notification in order to pause audio.
