...
object MusicDataHolder : MusicLibraryData {
    ...
    fun hook(data : MusicLibraryData) {
        if (data is MusicDataHolder) throw MusicApiError("Never hook MusicDataHolder into itself")
        dataLinker = data
    }

    fun getData() =
            if (dataLinker != null) dataLinker
            else throw MusicApiError("Please hook a MusicLibraryData object into MusicDataHolder")
