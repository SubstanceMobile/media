...
abstract class Playlist : MediaObject(), ArtworkHolder {
    ...
    @UiThread
    override fun requestArtworkLoad(target: ImageView) = CoreOptions.imageLoadAdapter?.onRequestLoad(artworkUri, AudioCoreOptions.defaultPlaylistArtworkRes, target) ?: mediaApiError(102)

    @WorkerThread
    override fun requestArtworkBitmap(): Bitmap = CoreOptions.imageLoadAdapter?.onRequestBitmap(artworkUri, AudioCoreOptions.defaultPlaylistArtworkRes) ?: mediaApiError(102)
